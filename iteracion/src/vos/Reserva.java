...
public class Reserva {
	...
	/**
	 * Costo de adquirir los servicios presntados por un operador
	 */
	...
	//Cosntructor 
	public Reserva(@JsonProperty(value="FechaConvenienteDeCancelacion")Date fechaConvenineteDeCancelacion,@JsonProperty(value="FechaInicial")Date fechaInicial,@JsonProperty(value="FechaFinal")Date fechaFinal,@JsonProperty(value="costo")Double costo,	@JsonProperty(value="id")Long id,@JsonProperty(value="Propuesta")Propuesta propuesta)
	{
	...
	/**
	 * 
	 * @param myCosto nuevo costo de una reserva
	 */
